...
deser_minmode(::Val{:TravelTimeBenefits}, _) = TravelTimeBenefits()
deser_minmode(::Val{:TravelTimeBenefitsCost}, _) = TravelTimeBenefitsCost()
deser_minmode(::Val{:TravelTimeBenefitsHealthBenefits}, _) = TravelTimeBenefitsHealthBenefits()
deser_minmode(::Val{:TravelTimeBenefitsHealthBenefitsCost}, _) = TravelTimeBenefitsHealthBenefitsCost()
