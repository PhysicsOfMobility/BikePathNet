...
_edge_load(e, minstate::ConsumerSurplusState) = minstate.aggregated_loads[e.source, e.destination]
_edge_load(e, seg, minstate::ConsumerSurplusState) = _edge_load(e, minstate)
_edge_load(e, minstate::ConsumerSurplusCostState) = minstate.aggregated_loads[e.source, e.destination] / e.cost
_edge_load(e, seg, minstate::ConsumerSurplusCostState) = minstate.aggregated_loads[e.source, e.destination] / seg.cost
_edge_load(e, minstate::ConsumerSurplusHealthBenefitsState) = minstate.aggregated_loads[e.source, e.destination]
_edge_load(e, seg, minstate::ConsumerSurplusHealthBenefitsState) = _edge_load(e, minstate)
_edge_load(e, minstate::ConsumerSurplusHealthBenefitsCostState) = minstate.aggregated_loads[e.source, e.destination] / e.cost
_edge_load(e, seg, minstate::ConsumerSurplusHealthBenefitsCostState) = minstate.aggregated_loads[e.source, e.destination] / seg.cost
