...
params["turn_penalty"] = Dict([
        ("large", [0.0]),
        ("medium", [0.0]),
        ("small", [0.0]),
        ])
params["intersection_penalty"] = Dict([
        ("large", [0.0]),
        ("medium", [0.0]),
        ("small", [0.0]),
        ])
params["bp_end_penalty"] = Dict([
        ("primary", Dict([(1, [0.0]), (2, [0.0]), (3, [0.0])])),
        ("secondary", Dict([(1, [0.0]), (2, [0.0]), (3, [0.0])])),
        ("tertiary", Dict([(1, [0.0]), (2, [0.0]), (3, [0.0])])),
        ("residential", Dict([(1, [0.0]), (2, [0.0]), (3, [0.0])])),
        ])
...
params["bpp_range"] = Vector(LinRange(0, 1, 101))
